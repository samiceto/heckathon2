...
const Hero = () => {
  return (
    <div className='w-[100vw] md:w-[1440px] h-[55vw] md:h-[716px] relative'>
                <Image src="/hero.png" alt="" width={1440} height={1440} className='w-[100vw] md:w-[1440px] h-[55vw] md:h-[716px]'></Image>
