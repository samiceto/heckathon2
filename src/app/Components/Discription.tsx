...
const Discription = () => {
  return (
    <div className='md:w-[1440px] md:h-[644px] w-[100vw] h-fit flex flex-col gap-14 my-10'>
        ...
        <div className='md:w-[1100px] md:h-[644px] w-[90vw] h-fit mx-auto'>
        ...
        <div className='md:w-[1239px] w-[90vw] mx-auto'>
        <Image src="/sofa2.png" alt="" width={1440} height={721} className='md:w-[1239px] w-[90vw] '></Image>
        </div>
    </div>
  )
}
