...
const Footer1 = () => {
  return (
    <div className='w-[100vw] md:w-[1440px] h-[700px] md:h-[505px] pb-[50px] pt-[10px] md:px-[80px] flex flex-col justify-between'>
        <hr />
        <div className="flex flex-col md:flex-row justify-evenly text-center md:text-start md:justify-between h-[600px] items-center w-fit md:w-[1200px] mx-auto ">
