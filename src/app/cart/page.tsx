    ...
    <div className='md:w-[1440px] md:h-[525px] w-[100vw] h-fit flex flex-col md:flex-row items-center justify-center my-6 md:my-1'>
        <div className='flex flex-col md:flex-row gap-10 '>
            <div className='flex flex-col gap-8'>
                ...
                <Image src="/img2.png" alt="" width={150} height={150} className='md:w-[105px] w-[70px] rounded-lg'></Image>
                <p className='text-gray-500 text-[12px]'>Rs. 250,000.00</p>
                <button className='py-2 px-2 rounded-lg border-2 text-[12px] border-black md:w-[50px] md:h-[50px] w-[30px] h-[30px]'>1</button>
                <p className=' text-[12px]'>Rs. 250,000.00</p>
